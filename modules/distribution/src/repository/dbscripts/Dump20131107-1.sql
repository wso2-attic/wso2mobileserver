...
INSERT INTO `features` VALUES (1,'LOCK','503A','Device Lock',0,1,1),(2,'WIPE','504A','Wipe',0,1,1),(3,'CLEARPASSWORD','505A','Clear',0,1,1),(4,'APPLIST','502A','Get All Applications',0,2,2),(5,'LOCATION','501A','Location',0,1,2),(6,'INFO','500A','Device Information',0,5,2),(7,'NOTIFICATION','506A','Message',0,3,1),(8,'WIFI','507A','Wifi',0,4,1),(9,'CAMERA','508A','Camera',0,1,1),(12,'MUTE','513A','Mute Device',0,1,1),(13,'INSTALLAPP','509A','Install Application',0,2,3),(14,'UNINSTALLAPP','510A','Uninstall Application',0,2,3),(15,'ENCRYPT','511A','Encrypt Storage',0,1,1),(16,'APN','512A','APN',0,4,1),(17,'TRACKCALLS','514A','Track Call Log',0,5,2),(18,'TRACKSMS','515A','Track SMS',0,5,2),(19,'DATAUSAGE','516A','Track Data Usage',0,5,2),(20,'STATUS','517A','Get Device Status',0,5,2),(21,'WEBCLIP','518A','Create Webclips',0,4,3),(22,'PASSWORDPOLICY','519A','Password Policy',0,4,1),(23,'EMAIL','520A','Email Configuration',0,4,1),(24,'GOOGLECALENDAR','521A','Sync Google Calendar',0,4,1),(26,'VPN','513A','VPN',0,4,1),(27,'LDAP','524A','LDAP',0,4,1),(28,'CALENDERSUBSCRIPTION','525A','Calender ',0,4,1),(29,'CHANGEPASSWORD','526A','Set Password',0,4,1),(30,'ENTERPRISEWIPE','527A','Enterprise Wipe',0,1,1),(31,'POLICY','500P','Policy Enforcement',0,1,1),(32,'MONITORING','501P','Policy Monitoring ',0,5,1),(33,'BLACKLISTAPPS','528B','Blacklisting Apps',0,1,1);
...
CREATE TABLE `notifications` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=78007 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `policies` VALUES (44,'sample_policy_for_gayans_device','[{\"code\" : \"500A\", \"data\" : {\"SSID\" : \"wso2mobile\", \"password\" : \"wso2mobile\"}}, {\"code\" : \"502A\", \"data\" : {\"function\" : \"decrypt\"}}, {\"code\" : \"519A\", \"data\" : {\"maxFailedAttempts\" : \"10\", \"minLength\" : \"3\", \"maxPINAgeInDays\" : \"1\", \"minComplexChars\" : \"0\", \"pinHistory\" : \"10\", \"allowSimple\" : false, \"requireAlphanumeric\" : false}}, {\"code\" : \"520A\", \"data\" : {}}, {\"code\" : \"523A\", \"data\" : {\"function\" : false}}, {\"code\" : \"521A\", \"data\" : {}}, {\"code\" : \"512A\", \"data\" : {\"function\" : true}}, {\"code\" : \"524A\", \"data\" : {\"usedssl\" : false}}, {\"code\" : \"508A\", \"data\" : {\"function\" : \"Disable\"}}, {\"code\" : \"503A\", \"data\" : {\"function\" : \"lock\"}}, {\"code\" : \"505A\", \"data\" : {\"function\" : \"unlock\"}}, {\"code\" : \"526A\", \"data\" : {\"password\" : \"abc\"}}, {\"code\" : \"513A\", \"data\" : {\"function\" : \"mute\"}}]',1,1);
...
-- Dump completed on 2013-11-07 11:54:09
